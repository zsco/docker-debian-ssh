...
RUN apt-get update && apt-get upgrade -y && apt-get install -y openssh-server openssl mysql-client apt-transport-https lsb-release ca-certificates wget git unzip nano
